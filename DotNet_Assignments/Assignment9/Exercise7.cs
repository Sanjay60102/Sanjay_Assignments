...
namespace Assignment9
{
    internal class Exercise7
    {
            ...
            List<Item> items = new List<Item>
        {
            ...
            // Get the name of the item ordered in the largest quantity in a single order
            var maxQuantityOrder = orders.OrderByDescending(o => o.Quantity).FirstOrDefault();
            ...
            // Find if there are any orders placed before January of this year
            DateTime januaryFirstThisYear = new DateTime(DateTime.Now.Year, 1, 1);
            bool anyOrdersBeforeJanuary = orders.Any(o => o.OrderDate < januaryFirstThisYear);
